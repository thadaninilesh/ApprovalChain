 ...
 */
public class FragmentManagerEditDetails extends Fragment {
    ...
    public FragmentManagerEditDetails() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editDetails.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                fragmentManage.editDetails(email,"edit", name, phone);
        ...
        if(et_name.getText().toString().isEmpty() || et_phone.getText().toString().isEmpty()){
            Fragment fragmentManagerDetails = new FragmentManagerEditDetails();
            FragmentManager fragmentManager = getFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.content_frame_manager, fragmentManagerDetails).commit();
